...
let settings = $state<ThemeSettings>({ mode: 'dark', darkName: 'default-dark', lightName: 'default-light', backgroundEffect: 'particles' });
...
export const themeStore = {
	...
	async loadFromServer() {
		...
		try {
			...
			if (s?.backgroundEffect && ['none', 'particles', 'grid', 'waves', 'orbs', 'constellation', 'dna', 'aurora', 'tunnel', 'fireflies', 'matrix'].includes(s.backgroundEffect)) {
