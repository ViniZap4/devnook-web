		...
		<div class="flex flex-col sm:flex-row items-center justify-between gap-4">
			<div class="flex items-center gap-3">
				<div class="relative">
					...
					<div class="absolute inset-0 w-2 h-2 rounded-full live-dot" style="background-color: var(--color-primary); opacity: 0.3;"></div>
				</div>
				<span class="text-xs font-semibold gradient-text">Dev Nook</span>
				<span class="text-[0.625rem] px-2 py-0.5 rounded-full" style="color: var(--color-text-dim); background: var(--color-surface);">v1.0</span>
			</div>
