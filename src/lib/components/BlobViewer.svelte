...
<div class="flex flex-col gap-3">
	...
	<div class="rounded-lg border border-white/[0.06] overflow-hidden">
		<div class="flex items-center justify-between px-4 py-2 border-b border-white/[0.06] bg-white/[0.02]">
					...
					<tbody>
						{#each lines as line, i}
							<tr class="hover:bg-white/[0.02]">
								<td class="px-3 py-0.5 text-right select-none opacity-30 text-[var(--color-text)] w-1 whitespace-nowrap border-r border-white/[0.06]">
									{i + 1}
								</td>
