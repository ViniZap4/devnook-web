...
<section>
	<div class="flex items-center justify-between mb-4">
		...
		<a href="/new" class="text-xs font-medium rounded-lg px-2.5 py-1 border border-[var(--color-border)] text-[var(--color-text)] opacity-60 hover:opacity-100 hover:bg-[var(--color-surface)] hover:border-[var(--color-primary)30] transition-all duration-200">
			+ New
		</a>
	</div>
