		...
		<div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
			<div class="rounded-xl border p-5 flex flex-col gap-3" style="border-color: var(--color-border); background: linear-gradient(135deg, var(--color-surface), var(--color-surface-hover));">
				<div class="flex items-center justify-between">
					...
					<div class="w-9 h-9 rounded-lg flex items-center justify-center" style="background-color: var(--color-info)15;">
			...
			<div class="rounded-xl border p-5 flex flex-col gap-3" style="border-color: var(--color-border); background: linear-gradient(135deg, var(--color-surface), var(--color-surface-hover));">
				<div class="flex items-center justify-between">
					...
					<div class="w-9 h-9 rounded-lg flex items-center justify-center" style="background-color: var(--color-success)15;">
			...
			<div class="rounded-xl border p-5 flex flex-col gap-3" style="border-color: var(--color-border); background: linear-gradient(135deg, var(--color-surface), var(--color-surface-hover));">
				<div class="flex items-center justify-between">
					...
					<div class="w-9 h-9 rounded-lg flex items-center justify-center" style="background-color: var(--color-warning)15;">
			...
			<div class="rounded-xl border p-5 flex flex-col gap-3" style="border-color: var(--color-border); background: linear-gradient(135deg, var(--color-surface), var(--color-surface-hover));">
				<div class="flex items-center justify-between">
					...
					<div class="w-9 h-9 rounded-lg flex items-center justify-center" style="background-color: var(--color-error)15;">
		...
		<div>
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
				<a href="/admin/users" class="rounded-xl border p-4 flex items-center gap-3 transition-all hover:border-[var(--color-primary)]" style="border-color: var(--color-border); background-color: var(--color-surface);">
					<div class="w-10 h-10 rounded-lg flex items-center justify-center shrink-0" style="background-color: var(--color-primary)10;">
